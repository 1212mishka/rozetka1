...
export const adminDeleteCategory = (id) => api.delete(`/api/admin/catalog/categories/${id}`);
...
export const getCheckoutLines = (checkoutId) => api.get(`/api/customer/checkouts/${checkoutId}/lines`);
...
export const getOrder = (orderId) => api.get(`/api/customer/orders/${orderId}`);
export const createProductReview = (data) => api.post('/api/customer/product-reviews', data);
...
export const getProductReviews = (productId) => api.get(`/api/products/${productId}/reviews`);
export const submitSellerForApproval = () => api.post('/api/seller/me/submit');