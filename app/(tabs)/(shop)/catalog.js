...
import { getCategories, searchProducts } from '../../../shared/api';
import { getProductImage } from '../../../shared/utils/productImages';
import { getCartItems, createCartTable } from '../../../features/cart';
      ...
      {loading ? (
        ...
        searchLoading ? (
          ...
          <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
            ...
            <Text style={{ fontFamily: 'Montserrat_400Regular', color: '#888', marginTop: 12 }}>Нічого не знайдено</Text>
          </View>
        ) : (
