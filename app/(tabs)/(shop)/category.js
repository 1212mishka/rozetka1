...
import { getCategoriesTree, getProducts } from '../../../shared/api';
import { useAuth } from '../../../features/auth/AuthContext';
import { addToWishlist, removeFromWishlist, getWishlistItems, createWishlistTable } from '../../../features/wishlist';
import { addToCart, createCartTable } from '../../../features/cart';
import { getProductImage, getProductImageFile } from '../../../shared/utils/productImages';
...
export default function CategoryScreen() {
  ...
  function toggleWishlist(product) {
    ...
    if (wishlistIds.has(product.id)) {
      ...
      setWishlistIds(function(prev) { return new Set(prev).add(product.id); });
    }
  }
      ...
      {loading ? (
        ...
        <ScrollView contentContainerStyle={s.listContent}>
          {filteredSubs.length === 0 ? (
            <View style={s.emptyContainer}>
              ...
              <Text style={s.emptyText}>Підкатегорії не знайдено</Text>
            </View>
          ) : (
            <>
        ...
        filteredProducts.length === 0 ? (
          <View style={s.emptyContainer}>
            ...
            <Text style={s.emptyText}>Товари не знайдено</Text>
          </View>
        ) : (
